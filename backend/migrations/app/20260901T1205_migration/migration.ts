...
import type { Contract as End } from '../../snapshots/23c12d9e25e2c64b2f20df7b92c10e0b26e34db2871f11d41d98069e07e8dda0/contract';
import endContract from '../../snapshots/23c12d9e25e2c64b2f20df7b92c10e0b26e34db2871f11d41d98069e07e8dda0/contract.json' with { type: 'json' };
  ...
  override get operations() {
    return [
      ...
      this.createTable({
        ...
        table: 'exercise',
        columns: [
          col('equipment', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'SERIAL', { notNull: true, codecRef: { codecId: 'pg/int4@1' } }),
          col('muscleGroup', 'text', { codecRef: { codecId: 'pg/text@1' } }),
